...
class UPSLite(plugins.Plugin):
    ...
    __version__ = "1.0.1"
    __license__ = "GPL3"
    __description__ = "A plugin that will add a voltage indicator for the UPS Lite v1.2"
    __name__ = "UPSLite"
    __help__ = "A plugin that will add a voltage indicator for the UPS Lite v1.2"
    __dependencies__ = {
        "apt": ["none"],
        "pip": ["scapy"],
    }
